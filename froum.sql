...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Апр 04 2019 г., 21:45
...
(1, 'Cinema', '/img/56986902.jpg', 336),
(2, 'Game', '/img/justin.jpg', 122),
(3, 'Fight', '/img/artist2.PNG', 515),
(4, 'Comics', '/img/левый_чел.jpg', 1072),
...
(1, 'Тут первая статья', 'Тут хороший текст для первой статьи. <br><img src=\"/img/young_kakashi.gif\"><br> Новый супер текст', '2019-02-08 18:59:22', 2600622, 2, 7, 1, 1, '/img/'),
(2, 'Тут вторая статья', 'Тут хороший текст для второй статьи', '2019-02-08 18:59:39', 229, 2, 4, 2, 27, ''),
(3, 'Тут третья статья', 'Тут такой же хороший текст для третьей статьи', '2019-02-08 19:00:01', 99, 1, 3, 3, 1, ''),
(4, 'Тут четвертая статья', 'Туть тоже очень хороший текст)', '2019-02-08 19:00:19', 59, 0, 2, 4, 27, ''),
(7, 'Пуская это будет седьмая статья', 'ТекстТЕкстТекст для седьмой статьи', '2019-02-08 20:54:38', 140038, 0, 1, 3, 27, ''),
(8, 'Тут восьмая статья', 'О да, это же текст для воьсмой статьи', '2019-02-08 20:55:23', 52, 1, 3, 1, 27, ''),
(9, 'Как же я рад что это девятая статья', 'Наверное это текст для девятой статьи', '2019-02-08 20:59:28', 41, 0, 3, 4, 27, ''),
(10, 'Название десятой статьи', 'Какой же это хороший текст десятой статьи', '2019-02-13 13:44:09', 74, 0, 2, 2, 1, '/img/young_kakashi.gif'),
(11, '11 статья', 'Текст 11 статья', '2019-02-13 13:58:20', 26, 0, 2, 1, 28, ''),
(12, '12 статья', 'Да-да текст 12 статьяи', '2019-02-15 23:37:12', 9, 0, 1, 2, 1, ''),
(13, 'Окей 13 статья', 'Я на самом деле уже устал придумывать новые текста для статей.', '2019-02-15 23:39:45', 4, 0, 0, 4, 1, ''),
(14, 'Попытка номер 14', 'Текст 14 Текст 14 Текст 14 Текст 14 Текст 14 Текст 14 Текст 14 Текст 14 Текст 14 ', '2019-02-15 23:42:21', 12, 0, 1, 1, 1, ''),
(15, 'Ровно 15 статья', '15 статей назад было 1 статья', '2019-02-16 14:20:29', 6, 0, 1, 4, 1, ''),
...
(1, 1, '123', 39, '2019-03-13 19:10:24'),
(2, 1, '123', 39, '2019-03-13 19:35:07'),
...
(1, 'mastak', '$2y$10$xfKCMSJFKLDtUErsSFDEIec8OOHLvKjZH4IAq4JxdMpTK2IWJ8rF.', 'farkhat.bakiev@mail.ru', '/img/stich3.jpg', '2019-01-31 13:27:40', NULL, 3, 'Я буду называть себя пхп разработчиком', '1'),
...
(27, 'admin', '$2y$10$fWn.nxBfLYuTvTZJ2VmFruFoGPmV5Qxv2Q4dd0ig2mMjRFcgak9IK', 'admin', '/img/artist3.png', '2019-02-08 18:45:03', '127.0.0.1', 3, '', NULL),
...
(31, 'proud', '$2y$10$2uxSerXC/IOV7FbQr/Z.JesQ4OorYD3XJvTmuF.gw2TU1KJDjnNmy', 'proud', '/img/смоки.jpg', '2019-02-26 19:12:08', '127.0.0.1', 2, 'Да-да я прауд', '1'),
...
(33, '505', '$2y$10$S05UO72KLVtRmudVcCg0JOblhXna95ZlRtZ0nz7njSzDbeZbhXQqW', '505', '/img/homer.gif', '2019-03-02 23:01:15', '127.0.0.1', 2, '', NULL),
